						...
						<ul>
								<li>
										<section  class="thumbnail-in">
												...
												<div class="im-thumbnail"><img alt="" src="{{ asset('img/edBase/assets/img/avatar2.png') }}" /></div>
												<label></label>
								...
								<li>
										<section class="thumbnail-in">
												...
												<div class="im-thumbnail"><img alt="" src="{{ asset('img/edBase/assets/img/avatar.png') }}" /></div>
