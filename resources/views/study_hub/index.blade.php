@extends('study_hub.partials.master')
    ...
    <body>
        ...
        <div class="parallax cover overlay cover-image-full home">
            <img class="parallax-layer" src="{{ asset('img/studyHub/images/photodune-4161018-group-of-students-m.jpg') }}" alt="Learning Cover" />
        ...
        <div class="parallax cover overlay height-300 margin-none">
            <img class="parallax-layer" data-auto-offset="true" data-auto-size="false" src="{{ asset('img/studyHub/images/photodune-6745579-modern-creative-man-relaxing-on-workspace-m.jpg') }}" alt="Learning Cover" />
                ...
                <div class="row">
                        ...
                        <div class="testimonial">
                            ...
                            <div class="media v-middle">
                                <div class="media-left">
                                    <img src="{{ asset('img/studyHub/images/people/50/guy-1.jpg') }}" alt="People" class="img-circle width-40" />
                                </div>
                                <div class="media-body">
                    ...
                    <div class="col-md-4">
                        <div class="testimonial">
                            ...
                            <div class="media v-middle">
                                <div class="media-left">
                                    <img src="{{ asset('img/studyHub/images/people/50/guy-8.jpg') }}" alt="People" class="img-circle width-40" />
                                </div>
                                <div class="media-body">
                                    <p class="text-subhead margin-v-5-0">
                                        <strong>Adrian D. <span class="text-muted">@ Mosaicpro Inc.</span></strong>
                    ...
                    <div class="col-md-4">
                        <div class="testimonial">
                            ...
                            <div class="media v-middle">
                                <div class="media-left">
                                    <img src="{{ asset('img/studyHub/images/people/50/guy-4.jpg') }}" alt="People" class="img-circle width-40" />
                                </div>
                                <div class="media-body">
                                    <p class="text-subhead margin-v-5-0">
                                        <strong>Adrian D. <span class="text-muted">@ Mosaicpro Inc.</span></strong>
