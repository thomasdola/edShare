	        ...
	        <div class="row">
	            ...
	            <span class="btn btn-circle btn-red-500 btn-lg"><i class="fa fa-graduation-cap"></i></span>
	                            ...
	                            <div class="panel-body">
	                                ...
	                                <div class="media v-middle">
	                                    <div class="media-left">
	                                        <img src="{{ asset('img/studyHub/images/people/50/guy-7.jpg') }}" alt="People" class="img-circle width-40" />
	                                    </div>
	                                    <div class="media-body">
	                                        <h4><a href="">Adrian Demian</a>
	                                            <br/>
	            ...
	            <span class="btn btn-circle btn-purple-500 btn-lg"><i class="fa fa-graduation-cap"></i></span>
	                            ...
	                            <div class="panel-body">
	                                ...
	                                <div class="media v-middle">
	                                    <div class="media-left">
	                                        <img src="{{ asset('img/studyHub/images/people/50/guy-6.jpg') }}" alt="People" class="img-circle width-40" />
	                                    </div>
	                                    <div class="media-body">
	                                        <h4><a href="">Adrian Demian</a>
	                                            <br/>
