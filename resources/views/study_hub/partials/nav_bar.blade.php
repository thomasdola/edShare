    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <div class="navbar-brand navbar-brand-logo">
                <a class="svg" href="{{ action('StudyHubController@index') }}">
        ...
        <div class="collapse navbar-collapse" id="main-nav">
            <ul class="nav navbar-nav navbar-nav-margin-left">
                <li class="dropdown">
                    <a href="{{ action('StudyCoursesController@index') }}">Courses</a>
                    {{-- <ul class="dropdown-menu">
                        <li><a href="website-directory-grid.html">All Courses</a></li>
                    </ul> --}}
                {{-- </li>
                <li class="dropdown">
